...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      emailjs
      .sendForm('service_nf2g8db', 'template_yll0rhf', form.current, {
        publicKey: 'YS1VTDnY1aUMhR3rf',
      })
      e.target.reset();
      setFormData({
        name: "",
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">saitejagajulams@gmail.com</span>

              <a href="mailto:saitejagajulams@gmail.com" className="contact__button">Write me {" "}<i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
            </div>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+91-810-635-5575</span>

              <a href="https://api.whatsapp.com/send?phone=+918106355575&text=Hello!" className="contact__button">Message me {" "}<i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
            </div>
